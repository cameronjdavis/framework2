...
class Console
{
    ...
    public function showExample()
    {
        ...
        $page = $this->pageBuilder->create()
                ->setTitle('Example Console Usage')
                ->setBody("<h1>Console commands</h1>
                        <p>A console-based entry point to the framework is available. The below output can be generated by running:</p>
                        <p style='font-size: x-large; font-weight: bold; font-family: monospace;'>$ php console.php " . \ConsoleRoutes::LIST_ROUTES . "</p>
                        <pre>{$output}</pre>
